...
public class PostResource {
    ...
    public ResponseEntity<Post> updatePost(@RequestBody Post post) throws URISyntaxException {
        ...
        userService.checkUserId(postRepository.findById(post.getUser().getId()).get().getUser().getId());
        Post result = postRepository.save(post);
    ...
    public ResponseEntity<Void> deletePost(@PathVariable Long id) {
        ...
        userService.checkUserId(postRepository.findById(id).get().getUser().getId());
