    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="tccApp.post.home.createOrEditLabel">Create or edit a Post</h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
          <Col md="8">
            {loading ? (
              ...
              <AvForm model={isNew ? {} : postEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  <Label id="tituloLabel" for="titulo">
                    Titulo
                  </Label>
                  <AvField id="post-titulo" type="text" name="titulo" />
                </AvGroup>
                <AvGroup>
                  <Label id="descricaoLabel" for="descricao">
                    Descricao
                  </Label>
                  <AvField id="post-descricao" type="text" name="descricao" />
                </AvGroup>
                <AvGroup>
                  <Label id="urlImagemLabel" for="urlImagem">
                    Url Imagem
                  </Label>
                  <AvField id="post-urlImagem" type="text" name="urlImagem" />
                </AvGroup>
